...
-- CREATE TABLE `fines` (
--   `fine_id` integer AUTO_INCREMENT PRIMARY KEY,
...
-- INSERT INTO members (name, email, password, address, membership_date, is_admin) VALUES
-- ('admin', 'admin@gmail.com', 'admin123', 'Cairo, Egypt','2024-01-01', 1)
